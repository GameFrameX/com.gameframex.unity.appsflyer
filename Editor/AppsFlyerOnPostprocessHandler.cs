...
{
    public sealed class AppsFlyerOnPostprocessHandler
    {
        /// <summary>
        /// https://github.com/AppsFlyerSDK/appsflyer-unity-plugin/blob/master/docs/Troubleshooting.md#updating-the-infoplist
        /// </summary>
